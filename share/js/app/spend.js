            ...
            $('#spendTable').DataTable({
                ...
                columnDefs: [
                    ...
                    },                    
                    {
                        targets: 7,
                        render: function (data, type, full, meta) {
                            if (full[8] == 'Đã xác nhận') return data;
                ...
                ajax: {
                    ...
                    data: function (d) {
                        ...
                        if (document.getElementById('isaccept').value == '1') {
                            d.isaccept = '1';
                            var arrayInput = $('#spendTable_wrapper :input[type="checkbox"]');
                            d.spendId = arrayInput.serialize();
                            var arrayFund = '';
...
checkAll = function (obj) {
    var arrCheckbox = document.getElementsByName('spendId');
...
acceptOnClick = function() {
    ...
    else errorMessage('Bạn chưa chọn bản ghi để xác nhận!');
}
